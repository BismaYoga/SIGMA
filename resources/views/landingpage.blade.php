    ...
    <header class="header-notlogin">
      <div class="header-notlogin"></div>
      	<ul class="nav-menu">
      		...
      		<li><a href="peminjaan.html" id="peminjamanText">Peminjaman</a></li>
      		<li><a href="informasi.html" id="informasiText">Informasi</a></li>
      		<li><a href="bookingansaya.html" id="bookinganSayaText">Bookingan Saya</a></li>
      		<li><a href="login.html" id="loginText">Login</a></li>
		</ul>
