        ...
        <main>
          ...
          <section class="faq-content-section">
            <div class="faq-wrapper">
              ...
              <div id="pembayaran" class="faq-container">
                <article class="faq-item">
                  <h2>Apakah ada biaya sewa ruangan?</h2>
                  <p>Ya, terdapat biaya sewa ruangan yang berbeda-beda tergantung jenis ruangan dan durasi penggunaan.</p>
                </article>
                <article class="faq-item">
                  <h2>Bagaimana cara melakukan pembayaran?</h2>
                  <p>Anda dapat melakukan pembayaran melalui (metode pembayaran yang tersedia, misal: transfer bank, kartu debit/kredit).</p>
                </article>
                <article class="faq-item">
                  <h2>Apa bukti pembayaran yang harus saya lampirkan?</h2>
                    <p>Setelah melakukan pembayaran, harap lampirkan bukti pembayaran pada sistem.</p>
                </article>
              </div>
            </div>
          </section>
