        ...
        <main>
          ...
          <section class="faq-content-section">
            <div class="faq-wrapper">
              ...
              <div id="status" class="faq-container">
                <article class="faq-item">
                  <h2>Bagaimana cara mengecek status pemesanan?</h2>
                  <p>Anda dapat melihat status pemesanan Anda di halaman "Bookingan Saya"</p>
                </article>
                <article class="faq-item">
                  <h2>Apa arti status "Menunggu Konfirmasi"?</h2>
                  <p>Pemesanan Anda masih dalam proses verifikasi oleh admin.</p>
                </article>
                <article class="faq-item">
                  <h2>Apa arti status "Dikonfirmasi"?</h2>
                  <p>Pemesanan Anda telah disetujui dan ruangan sudah siap digunakan.</p>
                </article>
                <article class="faq-item">
                  <h2>Apa arti status "Dibatalkan"?</h2>
                  <p>Pemesanan Anda telah dibatalkan, baik oleh Anda maupun oleh admin.</p>
                </article>
              </div>
            </div>
          </section>
