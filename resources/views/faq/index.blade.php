...
<body>
    <div class="notloginpeminjaman">
        ...
        <main>
          ...
          <section id="index"class="faq-content-section">
            <div class="faq-wrapper">
              ...
              <div class="faq-container">
                <article class="faq-item">
                  <h2>Bagaimana cara membuat akun?</h2>
                  <p>Untuk membuat akun, klik tombol daftar lalu isi formulir dengan data yang benar.</p>
                </article>
                <article class="faq-item">
                  <h2>Bagaimana cara mengubah kata sandi?</h2>
                  <p>Masuk ke akun Anda, lalu buka pengaturan dan pilih opsi "Ubah Kata Sandi".</p>
                </article>
                <article class="faq-item">
                  <h2>Apa yang harus dilakukan jika lupa kata sandi?</h2>
                  <p>Klik tombol "Lupa Kata Sandi" di halaman login, lalu ikuti instruksi untuk mereset kata sandi.</p>
                </article>
              </div>
            </div>
          </section>
