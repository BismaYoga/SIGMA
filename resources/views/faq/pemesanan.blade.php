        ...
        <section class="faq-content-section">
          <div class="faq-wrapper">
            <aside class="faq-sidebar">
              ...
              <div id="pemesanan" class="faq-container">
                <article class="faq-item">
                  <h2>Bagaimana cara mencari ruangan?</h2>
                  <p>Anda dapat mencari ruangan berdasarkan nama ruangan, kapasitas, fasilitas, atau tanggal yang diinginkan.</p>
                </article>
                <article class="faq-item">
                  <h2>Bagaimana cara melakukan pemesanan?</h2>
                  <p>Setelah menemukan ruangan yang diinginkan, klik tombol "Pesan". Isi formulir pemesanan dengan data yang lengkap, lalu konfirmasi pemesanan.</p>
                </article>
                <article class="faq-item">
                  <h2>Apa yang harus dilakukan jika pemesanan ditolak?</h2>
                  <p>Jika pemesanan ditolak, biasanya akan ada notifikasi yang menjelaskan alasan penolakan. Anda dapat mencoba memesan ruangan lain atau menghubungi admin untuk meminta bantuan.</p>
                </article>
                <article class="faq-item">
                  <h2>Bagaimana cara membatalkan pemesanan?</h2>
                  <p>Untuk membatalkan pemesanan, masuk ke akun Anda dan cari riwayat pemesanan. Klik tombol "Batalkan" pada pemesanan yang ingin dibatalkan.</p>
                </article>
              </div>
            </div>
          </section>
